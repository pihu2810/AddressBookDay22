...
{
	 static List<Contacts> addressBook;

	    public static void main(String[] args) {
	        addressBook = new LinkedList<Contacts>();
	    ...
	    private static void editContactDetails(Contacts editContact, Scanner scanner) {
	    ...
	    public static String validateFirstName(String firstName, Scanner scanner) {
	        ...
	        while (!inputMatcher.matches()) {
	            ...
	            System.out.println("length must not exceeds 10 (Exa: Vishaka)");
